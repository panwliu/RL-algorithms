...
parser.add_argument('--act_std', type=float, default=0.5)
parser.add_argument('--lr_a', type=float, default=1e-2)
parser.add_argument('--lr_c', type=float, default=1e-2)
parser.add_argument('--train_a_itrs', type=int, default=1)
...
# parser.add_argument('--train_a_itrs', type=int, default=1)
# parser.add_argument('--train_c_itrs', type=int, default=30)
...
agent = rll.algos.rlVPG(actor=actor, critic=critic, optimizers=[optimizer_a, optimizer_c], train_itrs=train_itrs)
